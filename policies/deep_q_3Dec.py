...
def get_features(obs):
    ...
    return np.array([food_L, food_R, food_F, body_R, body_L, body_F, enemy_R, enemy_L, enemy_F, enemy_B])

FEATURE_LABELS = ['food_L', 'food_R', 'food_F', 'body_R', 'body_L', 'body_F', 'enemy_R', 'enemy_L', 'enemy_F', 'enemy_B']
